...
class InlineBot:
    ...
    def __init__(self, kernel: Any | None) -> None:
        ...
        Args:
            kernel: TETKO kernel instance or None for standalone WebApp flow.
        """
    ...
    async def _create_via_botfather(
        ...
        *,
        ...
        try:
            ...
            await client.send_message(botfather, "TETKO Inline Bot")
            await asyncio.sleep(1)
        ...
        if (
            ...
            try:
                await bot.set_my_description(
                    description="TETKO inline bot for automation",
                )
                await bot.set_my_short_description(
                    short_description="TETKO inline assistant",
                )
                commands = [
    ...
    async def _configure_bot_via_botfather(self, client: Any) -> None:
        ...
        try:
            ...
            steps = [
                "/setdescription",
                f"@{self.username}",
                "I'm a bot from TETKO for inline actions.",
                "/setinline",
                f"@{self.username}",
                "mcub@TETKO~$ ",
                "/setinlinefeedback",
