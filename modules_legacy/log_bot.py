...
class LogBot(ModuleBase):
    ...
    config = ModuleConfig(
        ConfigValue(
            "banner_url",
            default="https://raw.githubusercontent.com/anhedonuya/TETKO-UserBot/main/tetkologo.png",
        ...
        ConfigValue(
            ...
            description=(
                ...
                "{tetko}, {kernel_version}, {started}, {commit_sha},\n"
    ...
    async def notify_new_commits(self, commits, branch):
        ...
        update_image_url = "https://raw.githubusercontent.com/anhedonuya/TETKO-UserBot/main/tetkologo.png"
    ...
    async def setup_log_chat(self):
        ...
        try:
            async for dialog in self.kernel.client.iter_dialogs():
                if dialog.title and "TETKO-logs" in dialog.title:
        ...
        try:
            ...
            created = await self.kernel.client(
                CreateChatRequest(
                    title=f"TETKO-logs [{me.first_name}]", users=users_to_invite
                )
            )
            ...
            try:
                ...
                _LOG_GROUP_AVATAR_URL = (
                    "https://raw.githubusercontent.com/anhedonuya/TETKO-UserBot"
                    "/main/tetkologo.png"
                )
    ...
    async def send_startup_message(self):
        ...
        image_url = (
            cfg.get("banner_url")
            or "https://raw.githubusercontent.com/anhedonuya/TETKO-UserBot/main/tetkologo.png"
        )
        ...
        tetko = await self.tetko_handler()
        module_version_text = self.lang("version", version=self.version, name=self.name)
        default_message = f"""<b>{tetko}</b> <b>{self.kernel.VERSION}</b> {self.lang["started"]}
